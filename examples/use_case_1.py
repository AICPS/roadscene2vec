...
if __name__ == "__main__":
    extract_seq() 
    visualize(r"C:\Users\harsi\av\sg2vec\config\scene_graph_config_real.yaml") #visualize extracted scenegraphs using the stored location in the scene graph config