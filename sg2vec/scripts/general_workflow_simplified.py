...
def execute():
    #preprocessing
    #==============================================        
    data_config = configuration(r"C:\users\harsi\av\sg2vec\config\data_config_real.yaml")
    ...
    #extraction
    #=============================================
    scene_config = configuration(r"C:\users\harsi\av\sg2vec\config\scene_graph_config_real.yaml")
